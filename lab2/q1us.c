...
// Other functions (replaceInFile and reorderFile) remain the same
            ...
            while (1) {
                ...
                switch (option) {
                    ...
                    case 2: {
                        ...
                        recvfrom(server_socket, str1, sizeof(str1), 0, (struct sockaddr*)&client_addr, &addr_size);
                        recvfrom(server_socket, str2, sizeof(str2), 0, (struct sockaddr*)&client_addr, &addr_size);

                        replaceInFile(file, str1, str2);
