...
void replaceInFile(FILE* file, const char* str1, const char* str2) {
    ...
    rewind(temp);        // Move to the beginning of the temporary file
    ...
    fclose(temp);         // Close and delete the temporary file
}
        ...
        while (1) {
            ...
            switch (option) {
                ...
                case 2: {
                    ...
                    send(client_socket, "String replaced", sizeof("String replaced"), 0);
                    break;
                }
